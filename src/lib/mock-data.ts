...
export const clients: Client[] = [
  ...
  },
  {
    ...
    company: "Império Burger",
    whatsapp: "(11) 97777-2222",
    email: "rafael@imperioburger.com",
    city: "Guarulhos",
  ...
  },
  {
    id: "c4",
    responsible: "Diretor",
    company: "Galeão Óticas",
    whatsapp: "(11) 95555-4444",
    email: "contato@galeaooticas.com",
    city: "São Paulo",
    segment: "Óticas",
    campaigns: 0,
    totalInvested: 0,
...
export const influencers: Influencer[] = [
  {
    ...
    name: "Ana Souza",
    publicName: "@anasouza",
    whatsapp: "(11) 99000-1111",
    instagram: "@anasouza",
    city: "São Paulo",
    neighborhood: "Centro",
    niche: "Moda e lifestyle",
    avgViews: 530,
    cpmInternal: 20,
    status: "Ativa",
    reliability: "Alta",
    lastCampaign: "Bella Moda",
  },
  {
    id: "i2",
    name: "Maria Lima",
    publicName: "@marialima",
    whatsapp: "(11) 99000-2222",
    instagram: "@marialima",
    city: "São Paulo",
  ...
  },
  {
    id: "i3",
    name: "Luana Reis",
    publicName: "@luanareis",
    whatsapp: "(11) 99000-3333",
    instagram: "@luanareis",
    city: "São Paulo",
    neighborhood: "Vila Nova",
    niche: "Lifestyle local",
    avgViews: 1200,
    cpmInternal: 20,
    status: "Ativa",
    reliability: "Média",
  ...
  },
  {
    id: "i4",
    name: "Camila Rocha",
    publicName: "@camilarocha",
    whatsapp: "(11) 99000-4444",
    instagram: "@camilarocha",
    city: "São Paulo",
    neighborhood: "Centro",
    niche: "Promoções locais",
    avgViews: 300,
    cpmInternal: 20,
    status: "Em teste",
    reliability: "Média",
  ...
  {
    id: "i5",
    name: "Ivina Bruna de Sa",
    publicName: "@ivina.bruna",
    whatsapp: "(11) 99000-5555",
    instagram: "@ivina.bruna",
    city: "São Paulo",
    ...
    status: "Ativa",
    reliability: "Alta",
    lastCampaign: "Galeão Óticas",
  },
  {
    id: "i6",
    name: "Susan Soares",
    publicName: "@susan.soares",
    whatsapp: "(11) 99000-6666",
    instagram: "@susan.soares",
    city: "São Paulo",
